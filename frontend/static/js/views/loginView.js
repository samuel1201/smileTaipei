...
export default class extends AbstractView {
  ...
  async getHtml() {
    return `
        <div class="login">
        <div class="title page">用戶登入</div>

        <!-- <div class="relative">
            <img src="../frontend/static/icon/user.svg" alt="帳號icon" class="icon" />
        ...
        <div class="buttonWrapper flexCenter">
            <div class="button flexCenter">登入</button>
            </div>


            <!-- <div class="relative">
            <img src="../frontend/static/icon/password.svg" alt="帳號icon" class="icon" />
