  ...
  async getHtml() {
    ...
    <div>
          ...
          <div class="flexRow gap8">
            ...
            <div class="switchIcon avtive flexCenter cursor">
              <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 0.499805L0.5 7.99981L1.55 9.0498L8 2.5998L14.45 9.0498L15.5 7.99981L8 0.499805Z" fill="#E51D88"></path>
              </svg>
            </div>
      ...
      <div class="tabWrapper">
        <div class="tabItem active">全部主題</div>
        <div class="tabItem">生活閒聊</div>
        <div class="tabItem">社區議題</div>
        <div class="tabItem">交易專區</div>
      </div>

      <div class="tableHeader communicate checkbox">
        <span></span>
        <span>分類</span>
        <span>標題</span>
        <span>發佈者</span>
      ...
      <div>
        <div class="tableList communicate checkbox">
          <!-- checkbox -->
